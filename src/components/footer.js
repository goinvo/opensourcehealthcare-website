...
const Footer = ({ children }) => (
  <footer>
    <div className="max-width content-padding pad-vertical pad-top--double">
      ...
      <p className="text--center"><Link to="https://www.goinvo.com/work/?category=open-source">See our company's open source projects</Link></p>
      <p className="text--center">
        ...
        <br /><a href="tel:+16178037043">617-803-7043</a>
      </p>
    </div>
  </footer>
)
